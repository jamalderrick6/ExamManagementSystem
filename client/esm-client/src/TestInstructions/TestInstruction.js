...
function TestInstruction(props) {
  console.log("test", props.selectedTest);
                  ...
                  <div className="instructions__wrapper__right">
                    ...
                    <div className="navigation__instructions">
                      ...
                      <div className="navigation__buttons__Feature">
                        ...
                        <p className="button__description">
                          Next: By clicking Previous button previous question will
                          appear to user
                        </p>
                      </div>
                      <div className="navigation__buttons__Feature">
                        ...
                        <p className="button__description">
                          Flag: By clicking Flag button, question will be marked for later review
                        </p>
                      </div>
                      <div className="navigation__buttons__Feature">
                        <Button
                        ...
                        <p className="button__description">
                          End Test: By clicking this button, the exam will automatically be marked complete. <b>There is no reverse!</b>
                        </p>
                      </div>
                    </div>
